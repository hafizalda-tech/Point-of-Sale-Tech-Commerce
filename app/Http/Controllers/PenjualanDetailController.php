...
class PenjualanDetailController extends Controller
{
    ...
    {
        // Cari berdasarkan kode_produk atau barcode
        ...
        // Cek duplikat produk dalam transaksi
        ...
        if ($existing) {
            $existing->jumlah += 1;
            $existing->subtotal = $existing->jumlah * $produk->harga_jual - (($produk->diskon / 100) * $produk->harga_jual * $existing->jumlah);
            $existing->update();
            return response()->json('Jumlah produk ditambah', 200);
        }
